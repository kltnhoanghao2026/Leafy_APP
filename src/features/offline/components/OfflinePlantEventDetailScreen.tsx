...
import { useOfflinePlantEventById } from "../hooks/useOfflineQueries";
import {
  getEventCategoryColors,
  getEventCategory,
  getEventTypeIcon,
} from "@/src/features/plant-event/components/plant-event.types";
import { PlantEventProgressModal } from "@/src/features/plant-event/components/PlantEventProgressModal";
...
export function OfflinePlantEventDetailScreen() {
  ...
  const { data: event, isLoading, isError, refetch } = useOfflinePlantEventById(id ?? "");
...
export default OfflinePlantEventDetailScreen;
